...
export function ScenarioLab({ allCountries, selectedIso, onWorkspaceChange }: ScenarioLabProps): ReactElement {
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-50 w-[min(760px,100vw)] overflow-y-auto border-l border-cyan-400/10 bg-[#0e1520]/98 p-5 text-slate-100 shadow-2xl">
      ...
      <WorkspacePanel workspace={workspace} health={health} onOpen={(item) => void loadWorkspace(item.id)} onCreate={createWorkspace} />
